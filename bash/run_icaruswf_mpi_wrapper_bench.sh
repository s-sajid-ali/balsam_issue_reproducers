...
export NUM_CLIENT_NODES=1
export NUM_CLIENT_RANKS_PER_NODE=30
export NUM_CLIENT_TOTAL_RANKS=$(($NUM_CLIENT_NODES*$NUM_CLIENT_RANKS_PER_NODE))
export NUM_CLIENT_HYPERTHREADS=2
export NUM_CLIENT_HARDWARE_THREADS_PER_RANK=4
...
aprun -n $NUM_CLIENT_TOTAL_RANKS \
	...
	-cc none \
	-p ${PDOMAIN} \
	${ICARUSWF_BUILD}/src/modules/mpi_wrapper -H --num_evts_per_rank 1 --root_file_path /projects/HEP_on_HPC/sajid/icarus_hepnos/data/detsim_00.root &> load_out
